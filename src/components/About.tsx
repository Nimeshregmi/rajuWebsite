    ...
    <>
      ...
      <main id="about" className=" flex w-full flex-col items-center justify-center dark:text-light">
        <Profilelayout classname="pt-16 ">
          <AnimatedText
            classname="!text-8xl dark:text-light  !mb-16 lg:!text-7xl md:text-5xl sm:!text-4xl md:!mb-10"
          ...
          <div className="grid w-full grid-cols-8 gap-18 sm:gap-8 ">
            <div className=" col-span-3 flex flex-col items-start justify-start mr-2 xl:col-span-4 md:order-2 md:col-span-8">
              ...
              <p className="font-medium">
                Whether I&apos;m working on a Video, UI/UX, or other digital
            ...
            <div
              className="col-span-3 relative h-max rounded-2xl border-2 border-solid dark:border-light  border-dark dark:bg-dark bg-light p-8 md:order-1  md:col-span-8
            xl:col-span-4"
            >
            ...
            <div className="col-span-2 flex flex-col items-end justify-between xl:col-span-8 xl:flex-row xl:items-center md:order-3 ">
              <div className="flex flex-col items-end justify-center xl:items-center">
                ...
                <h2
                  className="inline-block text-xl font-medium dark:text-light/75 text-dark/75 capitalize
